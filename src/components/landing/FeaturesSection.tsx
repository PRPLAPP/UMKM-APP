...
const features = (t: (k: string) => string) => [
  {
    icon: Users,
    title: t('featureVillagersTitle'),
    description: t('featureVillagersDesc'),
    color: 'bg-blue-500/10 text-blue-600 dark:text-blue-400',
  },
  {
    icon: Store,
    title: t('featureMsmeTitle'),
    description: t('featureMsmeDesc'),
    color: 'bg-blue-500/10 text-blue-600 dark:text-blue-400',
  },
  {
    icon: ShieldCheck,
  ...
  return (
    <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/30">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl mb-4">{t('featuresHeading')}</h2>
